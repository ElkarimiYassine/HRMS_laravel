					...
					<div class="main-header-right">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								<a class="profile-user d-flex" href=""><img alt="" src="{{ asset('./uploads/profiles/'.auth()->user()->profile) }}"></a>
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100px">
											<div class="main-img-user"><img alt="" src="{{ asset('./uploads/profiles/'.auth()->user()->profile) }}" class=""></div>
											<div class="mr-5 my-auto">
												<h6 class="ml-2"> {{ Auth::user()->name }} </h6><span  class="ml-2">{{ Auth::user()->email }}</span>
											</div>
										</div>
									</div>
									<a class="dropdown-item" href="{{ url('/home') }}"><i class="bx bx-user-circle"></i>Profile</a>
									<a class="dropdown-item" href="{{ route('logout') }}"
                                    onclick="event.preventDefault();document.getElementById('logout-form').submit();"><i
                                    class="bx bx-log-out"></i>Se déconnecter</a>
